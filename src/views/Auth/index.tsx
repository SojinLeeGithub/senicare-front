...
import { IdCheckRequestDto, SignInRequestDto, SignUpRequestDto, TelAuthRequestDto } from 'src/apis/dto/request/auth';
import { ResponseDto } from 'src/apis/dto/response';
import TelAuthCheckRequestDto from 'src/apis/dto/request/auth/tel-auth-check.request.dto';
...
function SnsContainer ({ type }: SnsContainerProps) {
    ...
    const onSnsButtonClickHandlr = (sns: 'kakao' | 'naver') => {
    ...
    return (
        <div className="sns-container">
            ...
            <div className="sns-button-container">
                <div className={`sns-button ${type === '회원가입' ? 'md ' : ''}kakao`} onClick={() => onSnsButtonClickHandlr('kakao')}></div>
                <div className={`sns-button ${type === '회원가입' ? 'md ' : ''}naver`} onClick={() => onSnsButtonClickHandlr('naver')}></div>
            </div>
        </div>
    );
...
function SignIn({ onPathChange }: AuthComponentProps) {
    ...
    const signInResponse = (responseBody: SignInResponseDto | ResponseDto | null ) => {
        ...
        responseBody.code === 'SF' ? '로그인 정보 불일치' :
