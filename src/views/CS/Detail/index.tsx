...
export default function CSDetail() {
  ...
  const  getCustomerResponse = (responseBody: GetCustomerResponseDto | ResponseDto | null) => {
      ...
      const { profileImage, name, birth, charger, chargerName, address }  = responseBody as GetCustomerResponseDto;
  ...
  const deleteCustomerReponse = (responseBody: ResponseDto | null) => {
    const message = 
    !responseBody ? '서버에 문제가 있습니다.' :
    responseBody.code === 'VF' ? '잘못된 접근입니다.' :
    responseBody.code === 'AF' ? '잘못된 접근입니다.' :
  ...
  const onDeleteButtonClickHandler = () => {
    ...
    deleteCustomerRequest(customerNumber, accessToken).then(deleteCustomerReponse);
  };
      ...
      <div className='top'>
        ...
        <div className='info-box'>
          <div className='info-item'>
            <div className='info-label'>고객이름</div>
